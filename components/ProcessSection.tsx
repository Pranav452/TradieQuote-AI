      ...
      <div className="mx-auto max-w-7xl">
          ...
          <div className="relative z-10 grid grid-cols-2 gap-8 md:grid-cols-4">
            {steps.map(({ Icon, label, text }) => (
              <div key={label} className="flex flex-col items-center text-center">
                ...
                <p className="text-sm font-medium text-zinc-100">{text}</p>
              </div>
            ))}
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 items-center gap-16 lg:grid-cols-2">
          <div className="relative pb-28 md:pb-32">
            ...
            <div className="animate-process-card-in absolute -bottom-5 -right-2.5 z-20 w-[280px] rounded-3xl bg-white p-6 shadow-2xl md:right-10 md:w-[320px]">
